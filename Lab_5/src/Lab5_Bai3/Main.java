...
abstract class Shape {
    ...
    public boolean equals(Object obj) {
        ...
        return filled == other.filled && color.equals(other.color);
    }
    @Override
...
class Square extends Rectangle {
    ...
    @Override
    public void setWidth(double width) { super.setWidth(width); super.setLength(width); }
    @Override
    public void setLength(double length) { super.setWidth(length); super.setLength(length); }
    @Override
    public String toString() {
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("\nThong tin hinh vuong (Square):");
        System.out.println(square);
        System.out.println("\nKiem tra equals:");
        System.out.println("Circle va Rectangle: " + circle.equals(rectangle));
        System.out.println("Rectangle va Square: " + rectangle.equals(square));
    }
}
